...
var greatAuthors = books
.filter((books) => books.sales > 1000000) // filter books
.map((books) => {return `${books.author} adalah penulis buku ${books.title} yang sangat hebat!`}); // menyusun untuk output
