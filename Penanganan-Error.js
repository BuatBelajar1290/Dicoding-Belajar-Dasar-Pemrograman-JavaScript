...
// TODO 1
class ValidationError extends Error { // untuk custom error 
  constructor(message) {
    super(message);
...
// TODO 2
function validateNumberInput(a, b, c) { // validasi apakah dari ketiga nilai tersebut ada yang non number
  if (typeof a !== "number") {
...
const detectTriangle = (a, b, c) => { // logika untuk menentukan apakah segitiga sama sisi || segitiga sama kaki || segitiga sembarang
    // TODO 3
    try {
...
// buat cek apakah output sesuai yang di inginkan ?
